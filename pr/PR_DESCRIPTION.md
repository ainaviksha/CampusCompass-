...
*   **Admin Panel**:
    ...
    *   `src/pages/admin/Login.jsx`: Admin login page (Pre-filled credentials for demo).
...
- [x] Admin Login works (Sticky Sidebar fixed).
- [x] CSV Import/Export works (Shadowing conflict fixed).
